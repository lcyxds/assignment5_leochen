...
const Charts = () => {
    ...
    const xScaleBar = d3.scaleBand()
        .domain(data.map(({ station }) => station))
        .range([innerWidth, 0]);
    // console.log(xScaleBar.domain());
                ...
                <Col>
                    <svg width={WIDTH} height={HEIGHT}>
                        <ScatterPlot offsetX={margin.left} offsetY={margin.top} data={data} xScale={xScaleScatter} yScale={yScaleScatter}
                            ...
                            hoveredX={hoveredX} setHoveredX={setHoveredX} hoveredY={hoveredY} setHoveredY={setHoveredY} />
                    </svg>
                    <Tooltip d={hoveredStation} x={hoveredX} y={hoveredY} />
                </Col>
                <Col>
                    <svg width={WIDTH} height={HEIGHT}>
